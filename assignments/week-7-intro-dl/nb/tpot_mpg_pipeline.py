...
tpot_data = pd.read_csv('/home/tmoradi/fourth-brain/fourth-brain-code/assignments/week-7-intro-dl/dat/train.csv.gz', sep=' ', dtype=np.float64)
...
results_df.to_csv('model_results_tpot.csv')